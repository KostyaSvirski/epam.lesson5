...
import by.svirski.lesson5.service.impl.ServiceOnRegexpImpl;


public class TestsForRegexpCorrect {
	
	private ServiceOnRegexpImpl service = new ServiceOnRegexpImpl();
